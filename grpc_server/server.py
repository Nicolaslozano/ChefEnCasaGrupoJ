...
class ServicioRecetas(RecetasServicer):
    ...
    def TraerRecetas(self, request, context):
        ...
        for row in records:
            ...
            tiempoPreparacion = row.tiempoPreparacion, ingredientes = row.ingredientes,  pasos = row.pasos, url_fotos = fotos, nombreCategoria = row.nombreCategoria, usuario_idusuario = row.usuario_idusuario)
